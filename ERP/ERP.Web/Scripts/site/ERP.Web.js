...
(function (ERP) {
    ...
    (function (Sale) {
        ...
        })(OrderShippingState = Sale.OrderShippingState || (Sale.OrderShippingState = {}));
    ...
    (function (Basic) {
        var BrandDialog = (function (_super) {
            ...
            function BrandDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.BrandForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var CategoryDialog = (function (_super) {
            ...
            function CategoryDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.CategoryForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var ColorGroupDialog = (function (_super) {
            ...
            function ColorGroupDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.ColorGroupForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var ProductColorDialog = (function (_super) {
            ...
            function ProductColorDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.ProductColorForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var ProductSizeDialog = (function (_super) {
            ...
            function ProductSizeDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.ProductSizeForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var SeasonDialog = (function (_super) {
            ...
            function SeasonDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.SeasonForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var ShipperDialog = (function (_super) {
            ...
            function ShipperDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.ShipperForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var SizeGroupDialog = (function (_super) {
            ...
            function SizeGroupDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.SizeGroupForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Basic) {
        var StyleDialog = (function (_super) {
            ...
            function StyleDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Basic.StyleForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Inventory) {
        var DepotDialog = (function (_super) {
            ...
            function DepotDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Inventory.DepotForm(_this.idPrefix);
                _this.form.DepotID.element.on('keyup', function (e) {
    ...
    (function (Inventory) {
        var DepotStockDialog = (function (_super) {
            ...
            function DepotStockDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Inventory.DepotStockForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Inventory) {
        var InventoryCountDetailDialog = (function (_super) {
            ...
            function InventoryCountDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Inventory.InventoryCountDetailForm(_this.idPrefix);
    ...
    (function (Purchase) {
        var PurchaseDetailDialog = (function (_super) {
            ...
            function PurchaseDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Purchase.PurchaseDetailForm(_this.idPrefix);
                // we can set cascade field in constructor
                // we could also use FilterField but in this case, when CategoryID is null
                // lookup editor would show all products in any category
                //this.form.ProductID.cascadeField = Inventory.DepotStockRow.Fields.DepotID;
    ...
    (function (Purchase) {
        var PurchaseListDialog = (function (_super) {
            ...
            function PurchaseListDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Purchase.PurchaseListForm(_this.idPrefix);
                _this.form.PurchaseId.element.on('keyup', function (e) {
                    // only auto number when a key between 'A' and 'Z' is pressed
                    if (e.which >= 65 && e.which <= 90)
                        _this.getNextNumber();
                });
    ...
    (function (Purchase) {
        var SupplierDialog = (function (_super) {
            ...
            function SupplierDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Purchase.SupplierForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Sale) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Sale.CustomerForm(_this.idPrefix);
                _this.ordersGrid = new Sale.CustomerOrdersGrid(_this.byId('OrdersGrid'));
                _this.ordersGrid.element.flexHeightOnly(1);
                _this.byId('NoteList').closest('.field').hide().end().appendTo(_this.byId('TabNotes'));
                ERP.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
    ...
    (function (Sale) {
        var OrderDialog = (function (_super) {
            ...
            function OrderDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Sale.OrderForm(_this.idPrefix);
                return _this;
            }
