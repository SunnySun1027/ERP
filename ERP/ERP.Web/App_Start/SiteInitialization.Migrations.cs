namespace ERP
{
    ...
    {
        private static string[] databaseKeys = new[] { "Default", "Northwind", "Shoes" };
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want ERP migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "ERP.Migrations." + databaseKey + "DB"
                };
