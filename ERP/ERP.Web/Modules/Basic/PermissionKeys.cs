...
namespace ERP.Basic
{
    ...
    public class PermissionKeys
    {
        ...
        {
            public const string Delete = "Basic:Customer:Delete";
            public const string Modify = "Basic:Customer:Modify";
            public const string View = "Basic:Customer:View";
        }

        public const string General = "Basic:General";
    }
}
