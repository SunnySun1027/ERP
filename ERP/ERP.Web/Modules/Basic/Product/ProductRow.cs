...
namespace ERP.Basic.Entities
{
    ...
    [ConnectionKey("Shoes"), DisplayName("Products"), InstanceName("Product"), TwoLevelCached]
    [ReadPermission(Basic.PermissionKeys.General)]
    [ModifyPermission(Basic.PermissionKeys.General)]
    [LookupScript("Basic.Product")]
    ...
    public sealed class ProductRow : Row, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(ProductColorRow), Multiple = true), NotMapped]
        [LinkingSetRelation(typeof(ProductProductColorRow), "ProductID", "ColorID")]
        [MinSelectLevel(SelectLevel.Details), NotNull]
        public List<Int32> ProductColor
        {
            get { return Fields.ProductColor[this]; }
            set { Fields.ProductColor[this] = value; }
        }

        [LookupEditor(typeof(ProductSizeRow), Multiple = true), NotMapped]
        [LinkingSetRelation(typeof(ProductProductSizeRow), "ProductID", "SizeID")]
        [MinSelectLevel(SelectLevel.Details), NotNull]
        public List<Int32> ProductSize
        {
            get { return Fields.ProductSize[this]; }
            set { Fields.ProductSize[this] = value; }
        }

        [DisplayName("Gallery Images"), MultipleImageUploadEditor(FilenameFormat = "Product/GalleryImages/~")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public ListField<Int32> ProductColor;
            public ListField<Int32> ProductSize;
            public readonly StringField GalleryImages;

            public RowFields()
                : base("Products")
            {
                LocalTextPrefix = "Basic.Product";
            }
        }
    }
}