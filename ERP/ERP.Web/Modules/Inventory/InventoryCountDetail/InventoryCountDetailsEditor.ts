...
namespace ERP.Inventory {
    ...
    export class InventoryCountDetailsEditor extends Common.GridEditorBase<InventoryCountDetailRow> {
        ...
        protected initEntityDialog(itemType: string, dialog: Serenity.Widget<any>) {
            ...
            (dialog as InventoryCountDetailDialog).depotID = this.depotID;
        }
