...
namespace ERP.Purchase.Entities
{
    ...
    [ConnectionKey("Shoes"), DisplayName("Suppliers"), InstanceName("Supplier"), TwoLevelCached]
    [ReadPermission(Purchase.PermissionKeys.General)]
    [ModifyPermission(Purchase.PermissionKeys.General)]
    [LookupScript("Purchase.Supplier")]
    public sealed class SupplierRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Country"), Size(15), LookupFiltering("Purchase.SupplierCountry")]
