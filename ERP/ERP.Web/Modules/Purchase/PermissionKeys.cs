...
namespace ERP.Purchase
{
    ...
    public class PermissionKeys
    {
        ...
        {
            public const string Delete = "Purchase:Customer:Delete";
            public const string Modify = "Purchase:Customer:Modify";
            public const string View = "Purchase:Customer:View";
        }

        public const string General = "Purchase:General";
    }
}
