...
namespace ERP.Sale.Entities
{
    ...
    [ConnectionKey("Shoes"), TableName("[dbo].[RetailOrderDetails]"), DisplayName("Retail Order Details"), InstanceName("Retail Order Details"), TwoLevelCached]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class RetailOrderDetailsRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Order"), Column("OrderID"), Size(14), PrimaryKey, ForeignKey("[dbo].[RetailOrders]", "OrderID"), LeftJoin("jOrder"), QuickSearch, TextualField("OrderCustomerId"), Updatable(false)]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "Sale.RetailOrderDetails";
            }
        }
    }
}
