...
namespace ERP.Sale.Entities
{
    ...
    [ConnectionKey("Shoes"), DisplayName("Order Details"), InstanceName("Order Detail"), TwoLevelCached]
    [ReadPermission(Sale.PermissionKeys.General)]
    [ModifyPermission(Sale.PermissionKeys.General)]
    public sealed class OrderDetailRow : Row, IIdRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[Order Details]")
            {
                LocalTextPrefix = "Sale.OrderDetail";
            }
        }
    }
}