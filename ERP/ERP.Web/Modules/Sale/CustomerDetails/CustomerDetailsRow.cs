...
namespace ERP.Sale.Entities
{
    ...
    [ConnectionKey("Shoes"), DisplayName("CustomerDetails"), InstanceName("CustomerDetails"), TwoLevelCached]
    [ReadPermission("Sale:General")]
    [ModifyPermission("Sale:General")]
    public sealed class CustomerDetailsRow : Row, IIdRow, INameRow
    {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            {
                LocalTextPrefix = "Sale.CustomerDetails";
            }
        }
    }
}