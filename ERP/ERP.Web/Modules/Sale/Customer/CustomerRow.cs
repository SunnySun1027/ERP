...
namespace ERP.Sale.Entities
{
    ...
    [ConnectionKey("Shoes"), DisplayName("Customers"), InstanceName("Customer"), TwoLevelCached]
    ...
    public sealed class CustomerRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Country"), Size(15), LookupFiltering("Sale.CustomerCountry")]
