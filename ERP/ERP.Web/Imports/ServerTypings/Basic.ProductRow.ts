namespace ERP.Basic {
    ...
    export namespace ProductRow {
        ...
        export const localTextPrefix = 'Basic.Product';
        export const lookupKey = 'Basic.Product';

        export function getLookup(): Q.Lookup<ProductRow> {
            return Q.getLookup<ProductRow>('Basic.Product');
        }
        ...
        export namespace Fields {
            ...
            export declare const ProductSize: string;
            export declare const GalleryImages: string;
        }

        ['ProductID', 'ProductName', 'ProductImage', 'Discontinued', 'SupplierID', 'CategoryID', 'QuantityPerUnit', 'UnitPrice', 'UnitsInStock', 'UnitsOnOrder', 'ReorderLevel', 'SupplierCompanyName', 'SupplierContactName', 'SupplierContactTitle', 'SupplierAddress', 'SupplierCity', 'SupplierRegion', 'SupplierPostalCode', 'SupplierCountry', 'SupplierPhone', 'SupplierFax', 'SupplierHomePage', 'CategoryName', 'CategoryDescription', 'CategoryPicture', 'ProductColor', 'ProductSize', 'GalleryImages'].forEach(x => (<any>Fields)[x] = x);
    }
}
